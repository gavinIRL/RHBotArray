...
while(True):
    ...
    tess_config = '--psm 6 --oem 3 -c tessedit_char_whitelist=01234567890ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'
    results = pytesseract.image_to_data(
        rgb, output_type=Output.DICT, lang='eng', config=tess_config)
